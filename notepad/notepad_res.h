...
#define STRING_FM_NORMAL    0x19A
#define STRING_FM_READONLY  0x19B
#define STRING_FM_OUTDATE   0x19C
#define STRING_FM_EDITING   0x19D
#define STRING_FM_CLASH     0x19E
